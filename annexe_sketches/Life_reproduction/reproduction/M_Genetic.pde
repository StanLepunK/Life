...
Genome archetype(float [] float_data, String [] data_name, int gender) {
  String [] string_data = new String[0] ;
  return archetype(float_data, string_data, data_name, gender) ;
}

Genome archetype(String [] string_data, String [] data_name, int gender) {
  float [] float_data = new float[0] ;
  return archetype(float_data, string_data, data_name, gender) ;
}
...
Genome archetype(float [] float_data, String [] string_data, String [] data_name, int gender) {
  ...
  if(float_data.length < 1 || string_data.length < 1) num_chromosome = 1 ;
  ...
  // init var
  for(int i = 0 ; i < gene_name.length ; i++) gene_name[i] = Integer.toString(i) ;
  int num_naming = 0 ;
  if (gene_name.length <= data_name.length) num_naming = gene_name.length ; else num_naming = data_name.length ;
